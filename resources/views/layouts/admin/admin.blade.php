...
<body class="bg-white text-gray-800 min-h-screen flex">
    ...
    <aside class="h-screen flex flex-col bg-gray-100 drop-shadow-lg/25 border-r border-gray-200   ">
        ...
        <!-- Menu -->
        <nav class="flex flex-col gap-2 text-sm font-medium px-2 py-4">

            <a href="{{ route('admin.index') }}" class="flex items-center gap-3 py-2 px-2 rounded-md hover:bg-blue-600/10 hover:text-blue-400 transition">
            ...
            <a href="{{ route('admin.customers.index') }}" class="flex items-center gap-3 py-2 px-2 rounded-md hover:bg-blue-600/10 hover:text-blue-400 transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users-round-icon lucide-users-round"><path d="M18 21a8 8 0 0 0-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"/></svg>
                <span>Clientes</span>
            </a>

            <a href="{{ route('admin.employees.index') }}" class="flex items-center gap-3 py-2 px-2 rounded-md hover:bg-blue-600/10 hover:text-blue-400 transition">
            ...
            <a href="{{ route('admin.services.index') }}" class="flex items-center gap-3 py-2 px-2 rounded-md hover:bg-blue-600/10 hover:text-blue-400 transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-scissors-icon lucide-scissors"><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/></svg>
                <span>Serviços</span>
            </a>

            <a href="{{ route('admin.products.index') }}" class="flex items-center gap-3 py-2 px-2 rounded-md hover:bg-blue-600/10 hover:text-blue-400 transition">
            ...
            <a href="{{ route('admin.auth.logout') }}" class="flex items-center gap-3 py-2 px-2 rounded-md text-red-400 hover:bg-red-600/10 hover:text-red-400 transition mt-auto">
    ...
    <main class="flex-1 p-10">
        <div class="space-y-8">
            <!-- Título -->
            <div>
                <h1 class="text-2xl font-semibold text-black">@yield('title')</h1>
                <p class="text-sm text-gray-900">@yield('subtitle')</p>
            </div>
            @yield('content')
        </div>
    </main>
