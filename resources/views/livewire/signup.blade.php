<div class="h-screen w-screen flex justify-between items-center">
    <div class="flex-2 flex flex-col h-full items-center justify-between bg-linear-to-r from-cyan-500 to-blue-500 text-white">
        <div class="text-center mt-20">
            <h1 class="text-6xl font-semibold mb-2">Cadastro</h1>
            <p class="font-semibold">Bem vindo ao barberApp!</p>
        </div>
        <form
            ...
            <div class="flex flex-col">
                <input type="password" placeholder="Senha" wire:model='password' class="rounded focus:outline-0 bg-sky-700 border border-2 border-sky-700 focus:border-sky-800 p-2">
            </div>
            <button type="submit" class="bg-white text-sky-700 py-2 px-8 rounded cursor-pointer hover:bg-sky-700/30 hover:text-white transition">Entrar</button>
        </form>
        <div class="text-center mb-20 z-50">
            <p class="text-sm font-medium">Já possui uma conta?</p>
            <a href=" {{ route("admin.auth.login") }}" class="text-bold bg-sky-700/70 hover:bg-sky-800 transition mt-2 cursor-pointer text-white px-4 py-1 rounded">login</a>
        </div>
    </div>
    ...
    <!-- SVGS de background -->
    <div class="absolute bottom-50 left-20 rotate-20">
    ...
    <div class="absolute bottom-20 left-50 rotate-340">
    ...
    <div class="absolute top-20 left-135 rotate-20">
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-package-icon lucide-package blur-xs text-white"><path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"/><path d="M12 22V12"/><polyline points="3.29 7 12 12 20.71 7"/><path d="m7.5 4.27 9 5.15"/></svg>
    </div>
    <div class="absolute top-55 left-150 rotate-340">
    ...
    <div class="absolute bottom-75 left-140 rotate-340 z-10">
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-scissors-icon lucide-scissors blur-xs text-white "><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/></svg>
    </div>
    <div class="absolute top-75 left-25 rotate-20 z-10">
